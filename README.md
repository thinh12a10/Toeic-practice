# TOEIC Speaking Agent - Restructured Project

A comprehensive TOEIC Speaking practice application with AI-powered evaluation, dynamic question generation, and integrated dictionary support.
...
# 2. Start Ollama (for AI evaluation) - in a separate terminal
ollama serve
...
For detailed setup instructions, see [Quick Start Guide](docs/START_HERE.md)
...
│   ├── agents/              # AI Agents
│   │   ├── __init__.py
│   │   ├── speaking_agent.py      # Main speaking practice agent
│   │   ├── evaluator_agent.py     # Response evaluation using LLM
│   │   └── dictionary_agent.py    # Word lookup & definitions
│   │
│   ├── ui/                  # User Interface Components
│   │   ├── __init__.py
│   │   ├── gui_app.py             # Main GUI application
│   │   └── dictionary_popup.py   # Dictionary popup window
│   │
│   ├── core/                # Core Business Logic
│   │   ├── __init__.py
│   │   ├── questions.py           # General question engine
│   │   ├── part1_questions.py    # Part 1 (Read Aloud) generator
│   │   └── feedback.py            # Feedback generation system
│   │
│   └── main.py              # Application entry point
│
├── tests/                    # Test files & validation
│   ├── test_mistral_evaluator.py  # Evaluator tests
│   └── test_dynamic_questions.py  # Question generation tests
│
├── docs/                     # Documentation (organized by feature)
│   ├── START_HERE.md                  # 📍 Start here first! (3 min setup)
│   ├── QUICKSTART.md                 # Quick reference guide
│   ├── README.md                     # Full documentation
│   ├── QUICK_REFERENCE.md            # Feature reference
│   ├── VISUAL_OVERVIEW.md            # Architecture overview
│   │
│   ├── setup/               # Setup & Installation Guides
│   │   ├── SETUP.md                 # Detailed setup instructions
│   │   ├── OLLAMA_SETUP.md         # Ollama configuration
│   │   └── OLLAMA_QUICKSTART.md    # Ollama quick reference
│   │
│   ├── dictionary/          # Dictionary Agent Documentation
│   │   ├── DICTIONARY_README.md
│   │   ├── DICTIONARY_SKILL.md
│   │   ├── DICTIONARY_IMPLEMENTATION.md
│   │   └── DICTIONARY_QUICKSTART.md
│   │
│   ├── evaluator/           # Response Evaluator Documentation
│   │   ├── MISTRAL_EVALUATOR.md
│   │   ├── MISTRAL_CHANGE_SUMMARY.md
│   │   └── BEFORE_AFTER_COMPARISON.md
│   │
│   └── checklists/          # Checklists & Implementation Summaries
│       ├── IMPLEMENTATION_CHECKLIST.md
│       └── IMPLEMENTATION_SUMMARY.md
│
├── main.py                   # Root entry point (wrapper script)
├── requirements.txt          # Python dependencies
├── .env.example              # Environment variables template
└── word_cache.json           # Dictionary cache (auto-generated)
```
...
├── feedback.py
├── main.py
├── 13+ .md files scattered everywhere
├── test files at root
└── ...
```

**Issues:**
- 🔴 13+ `.md` files cluttering root
...
### After ✅
- ✅ Source code organized by **feature** (`agents/`, `ui/`, `core/`)
- ✅ All tests in **`tests/`** folder
- ✅ All docs in **`docs/`** organized by **feature/topic**
- ✅ Clear import structure with `__init__.py` files
- ✅ Scales for new features/agents
...
Test the evaluator:
```bash
python -m pytest tests/test_mistral_evaluator.py
# Or: pytest tests/test_mistral_evaluator.py
```

Test dynamic question generation:
```bash
python tests/test_dynamic_questions.py
```
...
|----------|---------|:----------:|
| [docs/START_HERE.md](docs/START_HERE.md) | 3-minute setup guide | **✅ YES** |
| [docs/QUICKSTART.md](docs/QUICKSTART.md) | Quick reference | After START_HERE |
| [docs/setup/SETUP.md](docs/setup/SETUP.md) | Detailed installation | If issues arise |
| [docs/QUICK_REFERENCE.md](docs/QUICK_REFERENCE.md) | Feature reference | Feature overview |
| [docs/dictionary/](docs/dictionary/) | Dictionary agent docs | For dictionary feature |
| [docs/evaluator/](docs/evaluator/) | Evaluator docs | For scoring system |
...
# OR OpenAI (cloud-based, paid)
# OPENAI_API_KEY=sk-...

# OR Anthropic Claude (cloud-based, paid)
...
1. **New Agent**: Create in `src/agents/new_agent.py`
2. **New UI Component**: Create in `src/ui/new_component.py`
3. **New Core Logic**: Create in `src/core/new_logic.py`
4. **Tests**: Add to `tests/test_new_feature.py`
5. **Documentation**: Create in `docs/feature_name/README.md`
6. **Update `__init__.py`** files with exports
...
from src.core import Part1QuestionEngine
from src.core import FeedbackGenerator

# Or direct imports
from src.agents.speaking_agent import TOEICSpeakingAgent, UserProfile
...
If you have old files still in the root:

```bash
# Delete old files (they've been copied to new locations)
rm agent.py evaluator.py dictionary_agent.py gui_app.py
rm part1_questions.py questions.py feedback.py dictionary_popup.py
...
|---------|--------|----------|
| Part 1: Read Aloud | ✅ Complete | `src/` |
| GUI Application | ✅ Complete | `src/ui/` |
| LLM Evaluation | ✅ Complete | `src/agents/` |
| Dictionary/Vocabulary | ✅ Complete | `src/agents/` |
| Feedback Generation | ✅ Complete | `src/core/` |
| Dynamic Questions | ✅ Complete | `src/core/` |
| Part 2-6 | ⏳ Planned | `docs/` |
...
| `No module named 'gui_app'` | Using old imports; see above for new import patterns |
| Ollama not found | Make sure `ollama serve` is running in another terminal  |
| Microphone not working | Check OS permissions, device detection |
| Slow on first run | Normal; LLM model downloads take time |

## 📝 Project Stats

- **Source Files**: 8 modules in `src/`
- **Agent Components**: 3 specialized agents
- **UI Components**: 2 interfaces  
- **Core Engines**: 3 logic engines
- **Test Files**: 2 test suites
- **Documentation**: 20+ guides organized by feature

## 🚀 Next Steps

1. Read [START_HERE.md](docs/START_HERE.md) for quick setup
2. Run `python main.py` to launch
3. Explore features in the documentation
4. Check [QUICK_REFERENCE.md](docs/QUICK_REFERENCE.md) for commands
